...
return {{"Olical/conjure", ft = {"clojure", "fennel", "hy", "lua", "python"}, init = _1_}, {"hylang/vim-hy", lazy = true, ft = "hy"}, {"stevearc/conform.nvim", event = {"BufNewFile", "BufReadPre"}, keys = {{"<Leader>cf", _2_, desc = "Code format", mode = {"n", "v"}}, {"<Leader>cF", vim.cmd.ConformInfo, desc = "Code format", mode = {"n", "v"}}}, opts = {formatters = {["google-java-format"] = {prepend_args = {"--aosp"}}}, formatters_by_ft = {["*"] = {"trim_whitespace"}, c = {"clang-format"}, cs = {"csharpier"}, clojure = {"cljfmt"}, cpp = {"clang-format"}, css = {"prettier", "eslint_d"}, dart = {"dart_format"}, go = {"gofmt"}, haskell = {"ormolu"}, html = {"prettier", "eslint_d"}, java = {"google-java-format"}, javascript = {"prettier", "eslint_d"}, ["javascript.jsx"] = {"prettier", "eslint_d"}, javascriptreact = {"prettier", "eslint_d"}, json = {"prettier", "eslint_d"}, jsonc = {"prettier", "eslint_d"}, lua = {"stylua"}, markdown = {"prettier", "eslint_d"}, nix = {"nixfmt"}, odin = {"odinfmt"}, python = {"ruff_format"}, rust = {"rustfmt"}, scala = {"scalafmt"}, toml = {"taplo"}, typescript = {"prettier", "eslint_d"}, ["typescript.tsx"] = {"prettier", "eslint_d"}, typescriptreact = {"prettier", "eslint_d"}, typst = {"typstyle"}, vue = {"prettier", "eslint_d"}, zig = {"zigfmt"}}}}, {"neovim/nvim-lspconfig", event = {"BufReadPre", "BufNewFile"}, dependencies = {"hrsh7th/cmp-nvim-lsp"}, config = _3_}, {"nvim-treesitter/nvim-treesitter", branch = "main", build = {_5_, ":TSUpdate"}, init = _6_, lazy = false}, {"nvim-treesitter/nvim-treesitter-textobjects", branch = "main", opts = {}}, {"nvim-treesitter/nvim-treesitter-context", keys = {{"<Leader>cc", _9_, mode = "n", desc = "Jump to context (upwards)"}}, opts = {}, lazy = false}, {"folke/ts-comments.nvim", event = "VeryLazy", opts = {}}}
